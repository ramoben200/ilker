...
@Client.on_message(filters.command("start@missmusicsbot","start") & filters.private & ~filters.channel)
...
@Client.on_message(filters.command("reload@missmusicsbot","reload") & ~filters.private & ~filters.channel)
