...
@Client.on_message(commands("durdur@missmusicsbot","durdur") & other_filters)
@errors
...
@Client.on_message(commands("devam@missmusicsbot","devam") & other_filters)
@errors
@authorized_users_only
...
@Client.on_message(commands("son@missmusicsbot","son") & other_filters)
@errors
@authorized_users_only
...
@Client.on_message(commands("atla@missmusicsbot","atla") & other_filters)
@errors
@authorized_users_only
